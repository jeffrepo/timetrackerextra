    ...
    def _recompute_tax_lines(self, recompute_tax_base_amount=False, tax_rep_lines_to_recompute=None):
        ...
        def _compute_base_line_taxes(base_line):
            ...
            if move.is_invoice(include_receipts=True):
                ...
                if base_line.periodo > 0:
                    price_unit_wo_discount = sign * (base_line.price_unit * base_line.periodo) * (1 - (base_line.discount / 100.0))
                else:
                ...
                if base_line.periodo > 0:
                    price_unit_wo_discount = (base_line.amount_currency * base_line.periodo)
                else:
